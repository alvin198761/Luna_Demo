				...
				<el-menu style="border-top: 1px solid #475669;" default-active="/table" class="el-menu-vertical-demo" @open="handleopen"
					...
					<el-submenu index="4">
                    	<template slot="title"><i class="el-icon-message"></i>文件管理</template>
                    	 <el-menu-item index="/disk">文件操作</el-menu-item>
                     </el-submenu>
					<el-submenu index="2">
						<template slot="title"><i class="fa fa-id-card-o"></i>远程操作</template>
						<el-menu-item index="/form">分发文件</el-menu-item>
						<el-menu-item index="/ping">网络诊断</el-menu-item>
						<el-menu-item index="/form">创建文件</el-menu-item>
						<el-menu-item index="/form">文件删除</el-menu-item>
						<el-menu-item index="/form">命令执行</el-menu-item>
					</el-submenu>
					<el-submenu index="3">
					<template slot="title"><i class="fa fa-id-card-o"></i>用户和权限</template>
                       <el-menu-item index="/page3">用户管理</el-menu-item>
                       <el-menu-item index="/page3">权限分配</el-menu-item>
					</el-submenu>
				</el-menu>
			</aside>
			<!--</el-col>-->
